            ...
            <div class="header">
                ...
                <div class="content">
                    ...
                    <ul>
                        ...
                        <li><b>Facebook</b>: fb/lekshfancy</li>
                        <li><b>Email Id:</b>lekshfancy@gmail.com</li>
                    </ul>
                ...
                Copyright &copy;2023 Developed by Rama E.K. 
            lekshmi</footer></div>
            </div>
        </div>
    </body>
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <p>Buy Fancy items and Cosmetics online for Women from <span style="background-color:lime">Artsylife beauty store</span>
                ...
                <div class="footer">
                <footer style="color:white">
                Copyright &copy;2023 Developed by Rama E.K lekshmi</footer></div>
            </div>
        </div>
    </body>
</html>
...
<html lang="en">
    <head>
        ...
        .content{
            ...
            background-color:rgb(197, 188, 104);
            width:98%;
            height:2690px;
            padding:10px;
            margin-left:auto;
        ...
        .ceoph{
            background-image: url(/static/images/pic4.jpeg);
        ...
        .manph2{
            background-image: url(/static/images/pic6.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph1{
            background-image: url(/static/images/pic5.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph2{
            background-image: url(/static/images/pic1.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        .amph3{
            background-image: url(/static/images/pic3.jpeg);
            background-size: 250px;
            background-position-x: center;
            background-repeat: no-repeat;
            border:1px solid black;
        ...
        <div class="home">
            <div class="header">
                ...
                <div class="content">
                    ...
                    <div class="ceoph"></div>
                    <div class="ceo"><p align="center"><b><h2>Rama E.K. Lekshmi</h2></b></div>
                    <br>
                    <div class="text">
                        <p><b><u>Head executives</u></b></p><br>
                    </div>
                    <div class="manph1"></div>
                    <div class="man1"><p align="center"><b><h2>Uthaya</h2></b></p></div>
                    <div class="manph2"></div>
                    <div class="man2"><p><b><h2>Akshaya</h2></b></p></div>
                    <br>
                    <div class="text"><p><b><u>Managers</u></b></p></div><br>
                    <div class="amph1"></div>
                    <div class="am1"><p align="center"><b><h2>Kavya</h2></b></p></div>
                    <div class="amph2"></div>
                    <div class="am2"><p align="center"><b><h2>Amurtha</h2></b></p></div>
                    <div class="amph3"></div>
                    <div class="am3"><p align="center"><b><h2>Pooja</h2></b></p></div><br>
